  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.title}>CONDITIONS GENERALES D'UTILISATION</Text>
        <Text style={styles.subtitle}>En vigueur au 01/01/2024</Text>
        <Text style={styles.subtitle}>
          ...
          du site et des services par Toubidou et de définir les conditions
          ...
          CGU et je les accepte ». En cas de non-acceptation des CGU stipulées
          dans le présent contrat, l'Utilisateur se doit de renoncer à l'accès
          des services proposés par le site. toubidou@gmail.com se réserve le
          droit de modifier unilatéralement et à tout moment le contenu des
          présentes CGU.
        </Text>
        <Text style={styles.title}>ARTICLE 1 : LES MENTIONS LEGALES</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            L’édition et la direction de la publication du site
            toubidou@gmail.com est assurée par Lucien Letailleur, domicilié 298
            rue de férin. Numéro de téléphone est 0613093448 Adresse e-mail
            lucien.letailleur@gmail.com. L'hébergeur du site toubidou@gmail.com
            est la société OVH, dont le siège social est situé au 2 rue
            Kellermann, 59100 Roubaix.
          </Text>
        </Text>
        <Text style={styles.title}>ARTICLE 2 : ACCES AU SITE</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            Le site toubidou@gmail.com permet à l'Utilisateur un accès gratuit
            aux services suivants : Le site internet propose les services
            suivants : Fournir des todo-list,gestion de profil, connexion,
            inscription Le site est accessible gratuitement en tout lieu à tout
            ...
            et de son mot de passe qui lui seront communiqués après son
            ...
            n'engage pas la responsabilité de toubidou@gmail.com. Dans ces cas,
            l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de
        ...
        <Text style={styles.title}>ARTICLE 3 : COLLECTE DES DONNEES</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            ...
            droit : · par mail à l'adresse email toubidou@gmail.com · via son
            espace personnel ;
          </Text>
        </Text>
        <Text style={styles.title}>ARTICLE 4 : PROPRIETE INTELLECTUELLE</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            ...
            d'auteur. La marque Toubidou est une marque déposée par
            Toubidou.Toute représentation et/ou reproduction et/ou exploitation
            partielle ou totale de cette marque, de quelque nature que ce soit,
            est totalement prohibée. L'Utilisateur doit solliciter
            ...
            strictement interdite. Toute représentation totale ou partielle de
            ce site par quelque procédé que ce soit, sans l’autorisation
            expresse de l’exploitant du site Internet constituerait une
            contrefaçon sanctionnée par l’article L 335-2 et suivants du Code de
            ...
            reproduit, copie ou publie le contenu protégé doit citer l’auteur et
            sa source.
          </Text>
        </Text>
        <Text style={styles.title}>ARTICLE 5 : RESPONSABILITE</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            Les sources des informations diffusées sur le site
            toubidou@gmail.com sont réputées fiables mais le site ne garantit
            ...
            régulières, le site toubidou@gmail.com ne peut être tenu responsable
            ...
            contenue dans ce site. L'Utilisateur s'assure de garder son mot de
            passe secret. Toute divulgation du mot de passe, quelle que soit sa
            forme, est interdite. Il assume les risques liés à l'utilisation de
            son identifiant et mot de passe. Le site décline toute
            responsabilité. Le site toubidou@gmail.com ne peut être tenu pour
        ...
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            ...
            toubidou@gmail.com. Les cookies ne contiennent pas d’information
            ...
            toubidou@gmail.com. En naviguant sur le site, L’Utilisateur les
        ...
        <Text style={styles.subtitle}>
          <Text style={styles.subtitle}>
            Le site permet aux membres de publier les contenus suivants : To-do
            liste. Dans ses publications, le membre s’engage à respecter les
            règles de la Netiquette (règles de bonne conduite de l’internet) et
            les règles de droit en vigueur. Le site peut exercer une modération
            sur les publications et se réserve le droit de refuser leur mise en
            ligne, sans avoir à s’en justifier auprès du membre. Le membre reste
            titulaire de l’intégralité de ses droits de propriété
            intellectuelle. Mais en publiant une publication sur le site, il
